...
test('correct task should be deleted from correct array', () => {
    const action = removeTaskTC.fulfilled({taskId: '2', todolistId: 'todolistId2'}, 'required', {taskId: '2', todolistId: 'todolistId2'})
...
test('tasks should be added for todolist', () => {
    ...
    const action = fetchTasksTC.fulfilled({tasks: startState['todolistId1'], todolistId: 'todolistId1'}, 'requestId', 'todolistId')
